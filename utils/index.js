...
export const META_TAGS = {
	...
	url: 'https://markdown.franciscodiazpaccot.dev/'
}
...
export const JSON_META_TAGS = {
	...
	logoUrl: "https://i.ibb.co/cbTqWZK/markdown.png",
	url: 'https://markdown.franciscodiazpaccot.dev/json'
}

export const MINIFIED_META_TAGS = {
	title: 'Minified finder',
	description: "A simple finder for positions inside minified files",
	logoUrl: "https://i.ibb.co/cbTqWZK/markdown.png",
	url: 'https://markdown.franciscodiazpaccot.dev/minified-finder'
}
